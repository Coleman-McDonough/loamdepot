      ...
      <footer className="dark:bg-gray-dark relative z-10 bg-white pt-16 md:pt-20 lg:pt-24">
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-8 max-w-[360px] lg:mb-12">
                <SiteLink href="/" className="mb-4 inline-block">
                  <Image
        ...
        <div className="absolute right-0 top-14 z-[-1]">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <circle opacity="0.8" cx="49.5" cy="49.5" r="49.5" fill="#4caf50" />
            <mask
              id="mask0_94:899"
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#4caf50" stopOpacity="0.62" />
              ...
              >
                ...
                <stop offset="1" stopColor="#4caf50" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
